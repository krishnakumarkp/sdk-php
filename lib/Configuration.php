...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'http://192.168.100.25/apikey_auth_jwt';
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/v1.0.2/PHP';
    ...
    {
        $report  = 'PHP SDK (Person\Client) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 1.0.0' . PHP_EOL;
        $report .= '    SDK Package Version: v1.0.2' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return array(
          array(
            "url" => "http://192.168.100.25/apikey_auth_jwt",
